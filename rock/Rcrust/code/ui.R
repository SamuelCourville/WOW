...
tabPanel("Input Parameters",
  ...
  conditionalPanel("(input.bulk_comp_panel_minimiser)%2 == 0",
	...
	selectInput("apply_trace_correction", "Apply saturation corrections",c("None","Zircon Saturation (Watson & Harrison 1983)","Monazite saturation (Montel 1993)","Zircon and Monazite saturation"),selected="None",selectize=TRUE),
